 ...
 * @LastEditTime: 2023-03-30 00:28:23
...
<template>
	<view class="person-wrap">
		<view class="client-header">
			<!-- <view class="client-leftward">
				<u-icon name="arrow-leftward" color="#fff" class="client-leftwardImg"></u-icon>
			</view>
			 -->
		</view>
		<view class="client-main">
		    <view class="client-success">
          <view class="client-header-pay">
            <view class="client-congratulations">Pay card-makeing fee</view>
			      <view class="client-apply">500 U</view>
          </view>
          <view>
            <view class="first-select">
            <uni-data-select
              v-model="usdtType"
              :localdata="range"
          ...
          <view class="network-text">Network</view>
          <view class="first-select">
            <uni-data-select
              v-model="appid"
              :localdata="range"
        ...
        <view class="container-copy">
         ...
         <view class="coin-up">以上充币地址仅接受Trc20中的USDT，充入其他资产将无法找回造成的损失，ORZ对此不承担任何责任。</view>
         <view class="client-foot">
          <view class="client-back">Back</view>
          <view class="client-next">Next</view>
         </view>
			</view>
...
export default {
	data() {
      ...
      appSrc: 'http://www.baidu.com',
			message:'0xe4534234343243242323232323231',
		};
	},
  components: {
		VueQr 
...
.client{
	...
	&-success-image{
		...
		height: 100px;
		margin-top:47px;
		background: url('../../static/home/client-image.png') no-repeat;
		background-size: 100% 100%;
	}
	&-congratulations{
		font-size: 21px;
	...
	&-card{
		...
		height: 122px;
		margin-top:48px;
		background: url('../../static/home/client-card.png') no-repeat;
		background-size: 100% 100%;
	}
  &-box{
	width: 325px;
  ...
  &-continue{
	...
	font-weight: 500;
color: #1F1423;
	border-bottom: 1px solid #1F1423;
  }
}
.userForm{
  &_header{
